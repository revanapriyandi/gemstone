...
!(function () {
    ...
    -1 < navigator.platform.indexOf("Win") &&
        ...
        document.getElementsByClassName("table-responsive")[0] &&
            ((e = document.querySelector(".table-responsive")),
            new SimpleBar(e)),
    ...
    if (e.getAttribute("checked")) {
        ...
        for (C = 0; C < h.length; C++)
            h[C].closest(".card.bg-gradient-dark") ||
                (h[C].classList.remove("text-white"),
        ...
        for (var C = 0; C < S.length; C++)
            S[C].classList.contains("text-dark") &&
                (S[C].classList.remove("text-dark"),
                S[C].classList.add("text-white"));
        for (var C = 0; C < k.length; C++)
            k[C].classList.contains("text-sm") &&
                k[C].classList.add("text-white");
        ...
        for (var C = 0; C < f.length; C++)
            f[C].classList.remove("text-dark"),
                f[C].classList.add("text-white");
