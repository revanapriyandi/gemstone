<div class="modal fade" id="uploadLogoModal" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="" method="POST" enctype="multipart/form-data" id="formLogoBrand">
                @csrf
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">Upload Logo Brand</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="logo" data-bs-toggle="tooltip" title="Logo Brand">Logo <span
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            $('#formLogoBrand').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    url: "{{ route('brand.update.logo', ['id' => 'idd']) }}".replace('idd', $('#id')
                        .val()),
                    type: "POST",
                    data: formData,
                    contentType: false,
