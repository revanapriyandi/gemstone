...
@section('content')
    <form action="{{ route('metode-pembayaran.update', $data->id) }}" method="POST" enctype="multipart/form-data"
        id="editMetodeBayar">
        <div class="row mt-4">
            @csrf
            <div class="col-lg-4">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <img class="w-100 border-radius-lg shadow-lg mt-3 " src="{{ $data->logo_url }}"
                                    alt="{{ $data->name }}" alt="preview_image" id="preview_image">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" value="{{ $data->name }}" required autocomplete="current-name"
                                    id="name" autofocus>
                            ...
                            <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                ...
                                <input type="text" class="form-control @error('kode') is-invalid @enderror"
                                    name="kode" value="{{ $data->kode }}" required autocomplete="current-kode"
                                    id="kode">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <select name="keterangan" id="keterangan"
                                    ...
                                    <option value="manual" {{ $data->keterangan === 'manual' ? 'selected' : '' }}>
                                        Manual</option>
                                    <option value="otomatis" {{ $data->keterangan === 'otomatis' ? 'selected' : '' }}>
                                        Otomatis</option>
                                </select>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <select name="category" id="category"
                                    ...
                                    <option value="bank_transfer"
                                        {{ $data->category === 'bank_transfer' ? 'selected' : '' }}>
                                        Bank Transfer</option>
                                    <option value="e_wallet" {{ $data->category === 'e_wallet' ? 'selected' : '' }}>
                                        E-Wallet</option>
                                    <option value="over_the_counter"
                                        {{ $data->category === 'over_the_counter' ? 'selected' : '' }}>
                                        Over The Counter</option>
                                    <option value="credit_card" {{ $data->category === 'credit_card' ? 'selected' : '' }}>
                                        Credit Card</option>
                                    <option value="direct_debit"
                                        {{ $data->category === 'direct_debit' ? 'selected' : '' }}>
                                        Direct Card</option>
                                </select>
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control  @error('min_charge') is-invalid @enderror" placeholder="Min Charge" aria-label="Min Charge" aria-describedby="min_charge"   name="min_charge" value="{{ $data->min_value }}" required>
                                  </div>
